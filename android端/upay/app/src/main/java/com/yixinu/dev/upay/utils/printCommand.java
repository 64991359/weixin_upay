...
/**
 * Created by kyle on 18-1-28.
 */

public class printCommand {
    private static final String DEBUG_TAG = "EscCommand";
    public Vector<Byte> Command = null;
    ...
    public void queryRealtimeStatus(com.printer.EscCommand.STATUS status) {
    ...
    public void addPrintMode(com.printer.EscCommand.FONT font, com.printer.EscCommand.ENABLE emphasized, com.printer.EscCommand.ENABLE doubleheight, com.printer.EscCommand.ENABLE doublewidth, com.printer.EscCommand.ENABLE underline) {
        byte temp = 0;
        if(font == com.printer.EscCommand.FONT.FONTB) {
            temp = 1;
        }

        if(emphasized == com.printer.EscCommand.ENABLE.ON) {
            temp = (byte)(temp | 8);
        }

        if(doubleheight == com.printer.EscCommand.ENABLE.ON) {
            temp = (byte)(temp | 16);
        }

        if(doublewidth == com.printer.EscCommand.ENABLE.ON) {
            temp = (byte)(temp | 32);
        }

        if(underline == com.printer.EscCommand.ENABLE.ON) {
            temp = (byte)(temp | 128);
        }
    ...
    public void addSelectOrCancelUserDefineCharacter(com.printer.EscCommand.ENABLE enable) {
        byte[] command = new byte[]{(byte)27, (byte)37, (byte)0};
        if(enable == com.printer.EscCommand.ENABLE.ON) {
            command[2] = 1;
        } else {
            command[2] = 0;
        }
    ...
    public void addSetUnderLineMode(com.printer.EscCommand.UNDERLINE_MODE underline) {
    ...
    public void addTurnEmphasizedModeOnOrOff(com.printer.EscCommand.ENABLE enabel) {
        byte[] command = new byte[]{(byte)27, (byte)69, enabel.getValue()};
        this.addArrayToCommand(command);
    }

    public void addTurnDoubleStrikeOnOrOff(com.printer.EscCommand.ENABLE enabel) {
        byte[] command = new byte[]{(byte)27, (byte)71, enabel.getValue()};
        this.addArrayToCommand(command);
    }

    public void addSetPrintAndFeedPaper(byte dot) {
        byte[] command = new byte[]{(byte)27, (byte)74, dot};
        this.addArrayToCommand(command);
    }

    public void addSetCharacterFont(com.printer.EscCommand.FONT font) {
        byte[] command = new byte[]{(byte)27, (byte)77, font.getValue()};
        this.addArrayToCommand(command);
    }

    public void addSetInternationalCharacterSet(com.printer.EscCommand.CHARACTER_SET set) {
        byte[] command = new byte[]{(byte)27, (byte)82, set.getValue()};
        this.addArrayToCommand(command);
    }

    public void addSet90ClockWiseRotatin(com.printer.EscCommand.ENABLE enabel) {
    ...
    public void addSetJustification(com.printer.EscCommand.JUSTIFICATION just) {
    ...
    public void addSetCodePage(com.printer.EscCommand.CODEPAGE page) {
        byte[] command = new byte[]{(byte)27, (byte)116, page.getValue()};
        this.addArrayToCommand(command);
    }

    public void addSetUpsideDownMode(com.printer.EscCommand.ENABLE enable) {
        byte[] command = new byte[]{(byte)27, (byte)123, enable.getValue()};
        this.addArrayToCommand(command);
    }

    public void addSetCharcterSize(com.printer.EscCommand.WIDTH_ZOOM width, com.printer.EscCommand.HEIGHT_ZOOM height) {
    ...
    public void addSetReverseMode(com.printer.EscCommand.ENABLE enable) {
        byte[] command = new byte[]{(byte)29, (byte)66, enable.getValue()};
        this.addArrayToCommand(command);
    }

    public void addSetBarcodeHRPosition(com.printer.EscCommand.HRI_POSITION position) {
    ...
    public void addSetAutoSatusBack(com.printer.EscCommand.ENABLE enable) {
        byte[] command = new byte[]{(byte)29, (byte)97, (byte)0};
        if(enable == com.printer.EscCommand.ENABLE.OFF) {
            command[2] = 0;
        } else {
            command[2] = -1;
        }
    ...
    public void addSetBarcodeHRIFont(com.printer.EscCommand.FONT font) {
    ...
    public void addSetKanjiFontMode(com.printer.EscCommand.ENABLE DoubleWidth, com.printer.EscCommand.ENABLE DoubleHeight, com.printer.EscCommand.ENABLE Underline) {
    ...
    public void addSetKanjiUnderLine(com.printer.EscCommand.UNDERLINE_MODE underline) {
    ...
    public void addRastBitImage(Bitmap b) {
        ...
        if(NmBinaryBitmap != null) {
            ...
            Object codecontent = null;
            byte[] var9 = GpUtils.pixToESCCmd(GpUtils.bitmapToBWPix(GpUtils.resizeImage(GpUtils.toGrayscale(GpUtils.toBinaryImage(bmp, bmp.getWidth(), 16)), i, j)), i, 0);

            int k;
            for(k = 0; k < var9.length; ++k) {
                this.Command.add(Byte.valueOf(var9[k]));
            }
